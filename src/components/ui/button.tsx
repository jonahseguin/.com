  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-none text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        phthalo:
          "border border-phthalo bg-phthalo text-phthalo-foreground shadow-sm hover:bg-phthalo/90",
        ghostPhthalo:
          "text-phthalo-text hover:bg-phthalo hover:text-phthalo-foreground",
        secondary:
      ...
      size: {
        ghost: "p-0 m-0 h-min align-baseline",
